...
const ptComponents: PortableTextComponents = {
  block: {
    ...
    // H2 headers are GREEN
    h2: ({ children }) => (
      <h2 className="text-3xl font-bold text-text-heading mt-12 mb-6 border-l-4 border-card-economics pl-4">
        {children}
      </h2>
    ),
    h3: ({ children }) => (
    ...
    blockquote: ({ children }) => (
      <div className="bg-surface-muted p-8 rounded-xl border-l-4 border-card-economics my-8 shadow-sm">
