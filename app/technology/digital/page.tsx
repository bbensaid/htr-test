...
// 1. Fetch Data: Only get articles tagged "Technology"
...
export default async function DigitalHealthPage() {
  const articles = await getTechArticles();
    ...
    <div className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="mb-16 border-b border-ui-border pb-8">
        ...
        <p className="text-xl text-text-body leading-relaxed max-w-4xl">
          Analyzing the standards (FHIR, TEFCA) and platforms driving the next
          generation of connected care.
        </p>
      </div>
      ...
      <div className="grid gap-6">
        {articles.length === 0 && (
          <div className="p-10 text-center bg-surface-muted rounded-xl border border-ui-border">
            <p className="text-text-body mb-4">
              No technology analysis available yet.
            </p>
            <p className="text-sm text-text-body/60">
              Run the script with pillar: "Technology" to populate this list.
            </p>
          </div>
        )}
        ...
        {articles.map((article: any) => (
          ...
          >
            {/* INDIGO Hover Bar for Technology */}
            ...
            <div className="flex flex-col md:flex-row justify-between gap-6">
              ...
              <div className="flex-shrink-0 flex flex-col items-end justify-center gap-2">
                {/* Note: We link to a generic tech reader page here */}
                <Link
